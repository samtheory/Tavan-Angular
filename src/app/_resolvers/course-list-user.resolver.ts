...
export class CourseListUserResolver implements Resolve<Course[]> {
    pageNumber = 1;
    pageSize = 9;
    userParams: any = {};
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<Course[]> {
        ...
        return this.courseService.getUserCourses(this.pageNumber , this.pageSize, this.userParams).pipe(
            catchError(error => {
